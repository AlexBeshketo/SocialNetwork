...
export default function LoginForm({loginTC, isAuth, errorLoginServer}: LoginComponentType) {
    ...
    const {register, reset,handleSubmit, control,  setError, formState: {errors, isDirty}} = useForm<LoginUserModelType>();
            ...
            <Container component="main" maxWidth="xs">
                ...
                >
                    ...
                    <form onSubmit={onSubmit}>
                        ...
                        <div style={{color:'red'}}> {errors.password?.message ?  errors.password?.message  :  (!isDirty && errorLoginServer) }</div>
